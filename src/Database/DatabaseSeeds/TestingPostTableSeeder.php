    ...
    public function run(Faker $faker)
    {
        ...
        if ($this->doPopulateWithTestData()) {
            ...
            DB::table('posts')->insert([
                ...
                'featured_image_upload' => null,
                'featured_image_code' => null,
                'featured_image_external_file' => null,
                'enabled'             => 1,
